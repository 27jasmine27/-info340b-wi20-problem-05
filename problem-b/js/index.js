...
*/
let bday = document.querySelector('#dobInput');
bday.addEventListener('input', function() {
  if (getYearsSince(bday.value) < 13 || getYearsSince(bday.value) > 200) {
    bday.setCustomValidity("You need to be at least 13 years old.");
    let bdayFeedback = document.querySelector('#dobFeedback');
    bdayFeedback.textContent = "You need to be at least 13 years old.";
  } else {
...
//   let succeed = document.querySelector('#passwordInput');
//   let confSucceed = document.querySelector('#passwordConfirmInput');
//   let authSucceeded = document.querySelector('#passwordConfirmFeedback');

//   if(succeed.value == confSucceed.value) {
//     confSucceed.setCustomValidity("");
//     authSucceeded.textContent = "";
//   } else {
//     confSucceed.setCustomValidity("Passwords do not match.");
//     authSucceeded.textContent = "Passwords do not match.";
//   }
// }
function validatePasswordMatch() {
  let succeed = document.querySelector('#passwordInput');
...
*/
let authSucceeded = document.querySelectorAll('#passwordInput, #passwordConfirmInput');
authSucceeded.forEach(function(test) {
  test.addEventListener('input', validatePasswordMatch);
});
