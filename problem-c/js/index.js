...
function createTaskItemElement(taskObject) {
  ...
  li.textContent = taskObject.description;
  if(taskObject.complete) {
    li.classList.add('font-strike');
  }
  li.addEventListener('click', function () {
    taskObject.complete = !taskObject.complete //boolean toggling
    renderTaskList();
...
function renderTaskList() {
  ...
  ol.innerHTML = ''; //ERASE all content of the <ol>

  for(let taskOb of state.taskList) {
    let li = createTaskItemElement(taskOb);
    ol.appendChild(li);
  }
  renderInput();
}
...
function addNewTask() {
  let newTaskObj = {
   ...
   state.taskList.push(newTaskObj);
   state.inputtedText = '';
   renderTaskList();
}
...
//   }
//   li.addEventListener('click', function() {
//     taskObj.complete = !taskObj.complete //boolean toggling
//     renderTaskList();
//   });
// }
